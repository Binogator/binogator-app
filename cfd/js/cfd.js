...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("@deriv/account/dist/account/css/reset-trading-password-modal.css"), require("@deriv/account/dist/account/js/file-uploader-container"), require("@deriv/account/dist/account/js/form-sub-header"), require("@deriv/account/dist/account/js/poa-status-codes"), require("@deriv/account/dist/account/js/poi-poa-submitted"), require("@deriv/account/dist/account/js/proof-of-identity-containerfor-mt5"), require("@deriv/account/dist/account/js/reset-trading-password-modal"), require("@deriv/account/dist/account/js/sent-email-modal"), require("@deriv/components"), require("@deriv/shared"), require("@deriv/translations"), require("mobx"), require("mobx-react"), require("react"), require("react-dom"), require("react-router"), require("react-router-dom"));
	else if(typeof define === 'function' && define.amd)
		define(["@deriv/account/dist/account/css/reset-trading-password-modal.css", "@deriv/account/dist/account/js/file-uploader-container", "@deriv/account/dist/account/js/form-sub-header", "@deriv/account/dist/account/js/poa-status-codes", "@deriv/account/dist/account/js/poi-poa-submitted", "@deriv/account/dist/account/js/proof-of-identity-containerfor-mt5", "@deriv/account/dist/account/js/reset-trading-password-modal", "@deriv/account/dist/account/js/sent-email-modal", "@deriv/components", "@deriv/shared", "@deriv/translations", "mobx", "mobx-react", "react", "react-dom", "react-router", "react-router-dom"], factory);
...
/***/ "@deriv/account/dist/account/js/proof-of-identity-containerfor-mt5":
/*!************************************************************************************!*\
  !*** external "@deriv/account/dist/account/js/proof-of-identity-containerfor-mt5" ***!
  \************************************************************************************/
/***/ ((module) => {

module.exports = __WEBPACK_EXTERNAL_MODULE__deriv_account_dist_account_js_proof_of_identity_containerfor_mt5__;
...
/******/ 			return "cfd/js/cfd." + chunkId + "." + {"404":"bedbbbd32e89c9ef566d","vendors-node_modules_classnames_index_js-node_modules_formik_dist_formik_esm_js-node_modules_-611d03":"4d87207c4cf8909cc15c","cfd-app":"620fa1429227df3c2b30"}[chunkId] + ".js";
/******/ 		};
/******/ 	})();
/******/ 	
...
/******/ 			// return url for filenames based on template
/******/ 			return "cfd/css/cfd." + chunkId + "." + "754e7cea17b808cc3707" + ".css";
/******/ 		};
/******/ 	})();
/******/ 	
